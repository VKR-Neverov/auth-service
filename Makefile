...
run:
	make clean
	make build
	docker run --name ${APP_NAME} --network=zoo -dp 7040:7040 -e GRPC_PORT=7040 -e PROXY_PORT=7041 -e SWAGGER_PORT=7042 -e METRICS_PORT=7043 -e APP_NAME=${APP_NAME} -e ENV=local -e REDIS_PASSWORD=66fmYRVKXsJQrX2yYVvQ ${PROJECT_NAME}
